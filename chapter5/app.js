...
// let repeat = (n, action) => { // accepting a function as a parameter
//     for (let i = 0; i < n; i++) {
//         action(i); // using the function on 'i'.
//     }
// }

// repeat(7, console.log); // console.log is 'action'
...
// function noisy(f) { // takes in a function and it's args.
//     return (...args) => { // takes in args
//         console.log('calling with', args); // 'calling with [array of args];
//         let result = f(...args); // result = function 'f' ran on the args
//         console.log('called with', args, ', returned', result); // called with [array of args], returned 'result'.
//         return result;
//     };
// }
...
// SCRIPTS FROM ELOQUENT JS to practice filter, map, reduce, etc.
...
// let livingScripts = SCRIPTS.filter(script => script.living);
...
// let myArray = [1, 2, 3, 4];
// console.log(myArray.reduce((acc, val) => acc + val, 0));


// TRANSFORMING WITH MAP

// let livingScripts = SCRIPTS.filter(script => script.living);
// console.log(livingScripts.map(script => script.name));
...
// console.log(map(livingScripts, script => script.name));
...
//   console.log(filter(SCRIPTS, script => script.living)); // returns only the scripts that are living (true);
...
// let newArray = myArray.reduce((acc, value) => {
//     let finishedArray = acc.concat(value);
...
// let myLoop = (value, test, update, body) => {
...
// console.log(myLoop(myArray, testFunction));
...
// console.log(myArray.every(checkNumber)); // false
